...
All commits to the project must be "signed off".  This is done by adding a "Signed-off-by:" line in the commit message, with your name and email address.
